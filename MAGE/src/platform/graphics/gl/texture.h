...
#define T(NAME, TYPE, SIG, UPDATE) \
	...
	T(retained_texture2d, GL_TEXTURE_2D, (s_type w, s_type h, const uint32_t* const data, size_t count, const texture_options& options), (s_type x, s_type y, s_type w, s_type h, const void* const data));
