...
namespace mage::gfx
{
	orthographic_camera* orthographic_camera::create(float left, float right, float bottom, float top, const glm::vec3& pos, float rotation)
	{
...
namespace mage::gl
{
	void orthographic_camera::set_pos(const glm::vec3& pos)
	{
		...
		mage::gfx::orthographic_camera::set_pos({ pos.x, pos.y, 0.f });
	}
