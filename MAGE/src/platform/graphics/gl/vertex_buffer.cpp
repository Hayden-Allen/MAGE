...
namespace mage::gfx
{
	vertex_buffer* vertex_buffer::create_static(vertex_buffer::s_type* vertices, size_t count)
	{
		return new mage::gl::static_vertex_buffer(vertices, count);
	}
	vertex_buffer* vertex_buffer::create_dynamic(vertex_buffer::s_type* vertices, size_t count)
	{
		return new mage::gl::dynamic_vertex_buffer(vertices, count);
	}
}
