...
namespace mage::gfx
{
	index_buffer* index_buffer::create_static(index_buffer::s_type* indices, size_t count)
	{
		return new mage::gl::static_index_buffer(indices, count);
	}
	index_buffer* index_buffer::create_dynamic(index_buffer::s_type* indices, size_t count)
	{
		return new mage::gl::dynamic_index_buffer(indices, count);
	}
}
...
namespace mage::gl
{
	...
	index_buffer<USAGE>::index_buffer(s_type* indices, size_t count) :
