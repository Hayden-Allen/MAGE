...
namespace mage
{
	dynamic_batch::dynamic_batch() :
		coga::indexed_list<size_t, size_t, size_t, size_t>(COGA_MTU, c::dynamic_list_size),
		m_index(0),
		m_indices(new COGA_RAN::dynamic_index_buffer(COGA_MTU* c::indices_per_tile))
	{
		m_sprites.reserve(COGA_MTU);
