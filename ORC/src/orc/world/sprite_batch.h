...
namespace orc
{
	...
	class sprite_batch final :
		public mage::sprite_batch_base<mage::static_index_buffer, mage::retained_dynamic_vertex_buffer, mage::dynamic_vertex_array, sprite, sprite_bank>,
		public buildable
	{
	public:
	...
	private:
		...
		void add_sprite(sprite_bank::handle s);
